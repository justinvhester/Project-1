...
# Several instances of the class Movie defining Title, synopsis, movie
# poster URL, and trailer URL added a sixth value to each for the MPAA rating
the_avengers = media.Movie(
    "The Avengers",
    "Marvel's greatest heroes come together to watch the Incredible Hulk" \
    " smash.",
...
guardians_galaxy = media.Movie(
    ...
    "http://ia.media-imdb.com/images/M/MV5BMTAwMjU5OTgxNjZeQTJeQWpwZ15BbWU4MDUxNDYxODEx._V1_SX640_SY720_.jpg",  # noqa
    "https://youtu.be/d96cjJhvlMA",
    "PG-13")

brave = media.Movie(
    "Brave",
    "Epic set in (probably) Ireland about a daughter learning the importance" \
...
movies = [the_avengers, aliens, tropic_thunder,
          guardians_galaxy, brave, big_hero_six]
# Call the open_movies_page method from the fresh tomatoes module on
# the movies list.
